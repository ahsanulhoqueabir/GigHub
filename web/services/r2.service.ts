...
export class R2Service {
  private static readonly endpoint = `https://${r2.account}.r2.cloudflarestorage.com`;
  ...
  private static getClient() {
    ...
    if (!r2.account || !r2.accessKey || !r2.secretAccessKey || !r2.bucket) {
  ...
  static async uploadObject(params: UploadObjectParams): Promise<UploadResult> {
    try {
      ...
      const key = this.createObjectKey(params.fileName, params.folder);
